...
if(typeof window.Matomo!=="object")
{
    window.Matomo=window.Piwik=(function()
    {
        ...
        function s(at)
        {
            var av=new RegExp("^([a-z]+):"),au=av.exec(at);
            return au?au[1]:null
        }
        function d(at)
        {
            var av=new RegExp("^(?:(?:https?|ftp):)/*(?:[^@]+@)?([^:/#]+)"),au=av.exec(at);
            return au?au[1]:at
        }
        function G(at)
        {
        ...
        function aq(aI)
        {
            var av=function(aO,aN) {return(aO<<aN)|(aO>>>(32-aN))},aJ=function(aQ)
            {
                var aO="",aP,aN;
                for(aP=7; aP>=0; aP--)
                {
        ...
        var ai= {htmlCollectionToArray:
        function(av){var at=[],au; if(!av||!av.length)
            {
                return at
        ...
        function(at){if(!document.querySelectorAll||!at)
            {
                return[]
            } var au=document.querySelectorAll(at); return this.htmlCollectionToArray(au)
        },findMultiple:
        function(av)
        {
            if(!av||!av.length)
        ...
        function(au,at){if(!au||!at||!au.getElementsByTagName)
            {
                return[]
            } var av=au.getElementsByTagName(at); return this.htmlCollectionToArray(av)
        },makeNodesUnique:
        function(at){var ay=[].concat(at); at.sort(function(aA,az)
            {
                if(aA===az)
                {
                    return 0
            ...
            {
                return at
            } var au=0; var aw=0; var ax=[]; var av; av=at[au++]; while(av)
            {
                if(av===at[au])
                {
                    aw=ax.push(au)
        ...
        function(ax,av){if(!this.hasNodeAttribute(ax,av))
            {
                return
            ...
            {
                return
            } var aw=(typeof ax.attributes[av]); if("undefined"===aw)
            {
                return
            ...
            } var au; var at=ax.attributes; if(!at)
            {
                return
        ...
        function(av,at){if(av&&av.hasAttribute)
            {
        ...
        function(av,at){if(av&&at&&av.className)
            {
        ...
        },findNodesHavingAttribute:
        function(ax,av,at){if(!at)
            {
                at=[]
            } if(!ax||!av)
            {
                return at
            } var aw=S(ax); if(!aw||!aw.length)
            {
                return at
            } var au,ay; for(au=0; au<aw.length; au++)
            {
                ay=aw[au];
        ...
        function(ax,aw,at){if(!at)
            ...
            } var av=S(ax); if(!av||!av.length)
            {
                return[]
            } var au,az; for(au=0; au<av.length; au++)
            {
                az=av[au];
        ...
        function(au){if(!au)
            {
                return false
            } var at=String(au.nodeName).toLowerCase(); var aw=["a","area"]; var av=P(aw,at); return av!==-1
        },setAnyAttribute:
        function(au,at,av)
        {
            if(!au||!at)
        ...
        var w= {CONTENT_ATTR:"data-track-content"
        ...
        function(aw){if(!aw)
            {
                return[]
            } var au=ai.findNodesHavingCssClass(aw,this.CONTENT_CLASS); au=ai.findNodesHavingCssClass(aw,this.LEGACY_CONTENT_CLASS,au); var at=ai.findNodesHavingAttribute(aw,this.CONTENT_ATTR); if(at&&at.length)
            {
                var av;
            ...
            } au=ai.makeNodesUnique(au); return au
        ...
        function(at){var au=this.findTargetNodeNoDefault(at); if(au)
            {
                return au
            } return at
        },findContentName:
        ...
        function(at){if(!at||!at.indexOf)
            {
                return false
            } if(0===at.indexOf(this.getLocation().origin))
            {
                return true
            } var au=at.indexOf(this.getLocation().host); if(8>=au&&0<=au)
            {
                return true
            } return false
        },removeDomainIfIsInLink:
        function(av){var au="^https?://[^/]+"; var at="^.*//[^/]+"; if(av&&av.search&&-1!==av.search(new RegExp(au))&&this.isSameDomain(av))
            {
        ...
        function(at){return a(at)},isOrWasNodeInViewport:
        function(ay){if(!ay||!ay.getBoundingClientRect||ay.nodeType!==1)
            {
                return true
            } var ax=ay.getBoundingClientRect(); var aw=J.documentElement||{}; var av=ax.top<0; if(av&&ay.offsetTop)
            {
                av=(ay.offsetTop+ax.height)>0
            } var au=aw.clientWidth; if(W.innerWidth&&au>W.innerWidth)
            {
                au=W.innerWidth
            } var at=aw.clientHeight; if(W.innerHeight&&at>W.innerHeight)
            {
                at=W.innerHeight
            } return((ax.bottom>0||av)&&ax.right>0&&ax.left<au&&((ax.top<at)||av))
        },isNodeVisible:
        function(au){var at=i(au); var av=this.isOrWasNodeInViewport(au); return at&&av},buildInteractionRequestParams:
        function(at,au,av,aw){var ax=""; if(at)
            {
                ax+="c_i="+t(at)
            } if(au)
            {
        ...
        function(aw){if(!aw||!aw.length)
            {
                return[]
            } var av=[]; var at,au; for(at=0; at<aw.length; at++)
            {
        ...
        function(at){this.location=at},getLocation:
        function(){var at=this.location||W.location; if(!at.origin)
            {
        ...
        function(au)
        {
            ...
            if(au.search(/^\/\//)!==-1){return this.getLocation().protocol+au}if(au.search(/:\/\//)!==-1){return au}if(0===au.indexOf("#")){return this.getLocation().origin+this.getLocation().pathname+au}if(0===au.indexOf("?")){return this.getLocation().origin+this.getLocation().pathname+au
        }
            if(0===au.search("^[a-zA-Z]{2,11}:"))
    {
        return au
    }
    if(au.search(/^\//)!==-1){return this.getLocation().origin+au}var at="(.*/)";var av=this.getLocation().origin+this.getLocation().pathname.match(new RegExp(at))[0];return av+au},isUrlToCurrentDomain:function(au){var av=this.toAbsoluteUrl(au);if(!av){return false}var at=this.getLocation().origin;if(at===av){return true}if(0===String(av).indexOf(at)){if(":"===String(av).substr(at.length,1)){return false}return true}return false},setHrefAttribute:function(au,at){if(!au||!at){return}ai.setAnyAttribute(au,"href",at)},shouldIgnoreInteraction:function(at){if(ai.hasNodeAttribute(at,this.CONTENT_IGNOREINTERACTION_ATTR)){return true}if(ai.hasNodeCssClass(at,this.CONTENT_IGNOREINTERACTION_CLASS)){return true}if(ai.hasNodeCssClass(at,this.LEGACY_CONTENT_IGNOREINTERACTION_CLASS)){return true}return false}};function aa(au,ax){if(ax){return ax}au=w.toAbsoluteUrl(au);if(A(au,"?")){var aw=au.indexOf("?");au=au.slice(0,aw)}if(U(au,"matomo.php")){au=f(au,"matomo.php".length)
                    }
                else
        {
            if(U(au,"piwik.php"))
    ...
    {
        var ay=W.name.split("###"),ax=ay[1],at=ay[2],aw=ay[3],aA=aa(au,az);
    ...
    function T(cj,cf)
    {
        var bP=this,bj="mtm_consent",cL="mtm_cookie_consent",cU="mtm_consent_removed",ca=ae(J.domain,W.location.href,N()),c2=O(ca[0]),bT=p(ca[1]),bu=p(ca[2]),c0=false,cn="GET",dj=cn,aM="application/x-www-form-urlencoded; charset=UTF-8",cE=aM,aI=cj||"",bO="",c9="",ct="",cc=cf||"",bF="",bU="",ba,bp="",dg=["7z","aac","apk","arc","arj","asf","asx","avi","azw3","bin","csv","deb","dmg","doc","docx","epub","exe","flv","gif","gz","gzip","hqx","ibooks","jar","jpg","jpeg","js","mobi","mp2","mp3","mp4","mpg","mpeg","mov","movie","msi","msp","odb","odf","odg","ods","odt","ogg","ogv","pdf","phps","png","ppt","pptx","qt","qtm","ra","ram","rar","rpm","rtf","sea","sit","tar","tbz","tbz2","bz","bz2","tgz","torrent","txt","wav","wma","wmv","wpd","xls","xlsx","xml","z","zip"],aC=[c2],bG=[],co=[],bR=[],be=[],bQ=500,c5=true,cR,bb,bX,bV,at,cw=["pk_campaign","mtm_campaign","piwik_campaign","matomo_campaign","utm_campaign","utm_source","utm_medium"],bN=["pk_kwd","mtm_kwd","piwik_kwd","matomo_kwd","utm_term"],bq="_pk_",az="pk_vid",a5=180,c7,bw,bY=false,aN="Lax",bs=false,cY,bk,bC,cS=33955200000,cu=1800000,df=15768000000,a8=true,bL=false,bn=false,bW=false,aV=false,ch,b2= {},cs= {},bt= {},bA=200,cA= {},da= {},dh= {},cg=[],ck=false,cJ=false,au=false,di=false,cV=false,aS=false,bi=v(),cF=null,c8=null,aW,bI,cd=aq,bv,aQ,bH=false,cx=0,bB=["id","ses","cvar","ref"],cI=false,bJ=null,cT=[],cz=[],aB=X++,aA=false,c6=true;
        try
        {
            bp=J.title
        }
        ...
        function aH(dv)
        {
            ...
            var dt=new RegExp("(^|;)[ ]*"+dv+"=([^;]*)"),du=dt.exec(J.cookie);
            return du?V(du[2]):0
        }
        bJ=!aH(cU);
        ...
        function cv(dt,dv)
        {
            ...
            du.onload=function()
            {
                ...
                {
                    dv({request:dt,trackerUrl:aI,success:true})
                }
            };
            du.onerror=function()
            {
                if(typeof dv==="function")
                {
                    dv({request:dt,trackerUrl:aI,success:false})
                }
            };
        ...
        function bc(dx,dA,dz)
        {
            ...
            var dw= {type:"application/x-www-form-urlencoded; charset=UTF-8"};
            var dB=false;
            var du=aI;
            try
            {
            ...
            {
                dA({request:dx,trackerUrl:aI,success:true,isSendBeacon:true})
            }
            return dB
        }
            ...
            setTimeout(function()
            {
                    ...
                    dx.onreadystatechange=function()
                    {
                        if(this.readyState===4&&!(this.status>=200&&this.status<300))
                        {
                            ...
                            else
                            {
                                if(typeof dv==="function")
                                {
                                    dv({request:du,trackerUrl:aI,success:false,xhr:this})
                                }
                            }
                        }
                        else
                        {
                            ...
                            {
                                dv({request:du,trackerUrl:aI,success:true,xhr:this})
                            }
                        }
                    };
                ...
                catch(dw)
                {
                    ...
                    else
                    {
                        if(typeof dv==="function")
                        {
                            dv({request:du,trackerUrl:aI,success:false})
                        }
                    }
                }
            },50)
        ...
        function dq()
        {
            ...
            af++;
            u.addPlugin("HeartBeat"+af, {unload:function()
            {
                if(aS&&dm())
                {
                    bX()
        ...
        function cQ()
        {
            ...
            var du,dw,dx= {pdf:"application/pdf",qt:"video/quicktime",realp:"audio/x-pn-realaudio-plugin",wma:"application/x-mplayer2",fla:"application/x-shockwave-flash",java:"application/x-java-vm",ag:"application/x-silverlight"};
        ...
        function cW()
        {
            ...
            var dv=new Date(),dt=Math.round(dv.getTime()/1000),du=aY("id"),dy=aH(du),dx,dw;
            if(dy)
            {
                dx=dy.split(".");
                dx.unshift("0");
        ...
        function a4()
        {
            var dw=cW(),du=dw[0],dv=dw[1],dt=dw[2];
            return{newVisitor:du,uuid:dv,createTs:dt}
        }
        function aL()
        {
            var dw=new Date(),du=dw.getTime(),dx=a4().createTs;
        ...
        function aR(dt)
        {
            ...
            var dv=new Date(),du=Math.round(dv.getTime()/1000);
            if(!M(dt))
            {
                dt=a4()
            }
        ...
        {
            var dO,du=new Date(),dC=Math.round(du.getTime()/1000),dz,dM,dw=1024,dV,dD,dL=aV,dx=aY("ses"),dJ=aY("ref"),dG=aY("cvar"),dH=aH(dx),dN=bS(),dR=ba||bT,dA,dt;
            if(bs)
            {
                aJ()
            }
            ...
            aR(dI);
            ci();
            dv+=ag(dQ, {tracker:bP,request:dv});
            if(c9.length)
            {
                dv+="&"+c9
            }
        ...
        {
            var dz="idgoal=0",du=new Date(),dB=[],dC,dy=String(dw).length;
            if(dy)
            {
                dz+="&ec_id="+t(dw)
            }
        ...
        function cC(dx,dt,dy,du)
        {
            ...
            var dw=a6(bR,"download"),dv=a6(be,"link"),dz=new RegExp("\\.("+dg.join("|")+")([?&#]|$)","i");
            if(dv.test(dx))
            {
                return"link"
            }
        ...
        var bK= {enabled:true,requests:[],timeout:null,interval:2500,sendRequests:function()
        {
        ...
        },canQueue:function(){return !m&&this.enabled},pushMultiple:function(du)
        {
            if(!this.canQueue())
            {
                dp(du,bQ);
        ...
        {
            var dw= {pf_net:dx,pf_srv:dz,pf_tfr:dy,pf_dm1:du,pf_dm2:dA,pf_onl:dv};
            try
            {
                dw=Q(dw,M);
                dw=B(dw);
        ...
        this.requireConsent=function()
        {
            ...
            y++;
            b["CoreConsent"+y]= {unload:function()
            {
                if(!bJ)
                {
                    aJ()
        ...
        u.addPlugin("TrackerVisitorIdCookie"+aB, {unload:function()
        {
            if(!aA)
            {
                aR()
    ...
    ar(W,"beforeunload",am,false); ar(W,"visibilitychange",function()
    {
        if(m)
        {
            return
    ...
    },false); ar(W,"message",function(ay)
    {
        if(!ay||!ay.origin)
        {
            return
    ...
    },false); Date.prototype.getTimeAlias=Date.prototype.getTime; u= {initialized:false,JSON:W.JSON,DOM:{addEventListener:function(aw,av,au,at)
    {
        var ax=typeof at;
        if(ax==="undefined")
        {
        ...
        ar(aw,av,au,at)
    },onLoad:n,onReady:q,isNodeVisible:i,isOrWasNodeVisible:w.isNodeVisible
                                                                                                        },on:function(au,at)
    {
        if(!z[au])
        {
